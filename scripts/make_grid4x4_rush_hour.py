...
NETDIR = os.path.join(ROOT, "envs", "grid4x4_rush_hour")
...
def ensure_routes():
    ...
    <routes>
      ...
      <!-- Phase 1: 0-600, heavy West->East, light other directions -->
      <flow id="w2e_morning" type="car"
            begin="0" end="600"
            probability="0.08"
            from="left0" to="right1"/>
      <flow id="e2w_morning" type="car"
            begin="0" end="600"
            probability="0.02"
            from="right1" to="left0"/>
      <flow id="s2n_morning" type="car"
            begin="0" end="600"
            probability="0.03"
            from="bottom0" to="top1"/>
      <flow id="n2s_morning" type="car"
            begin="0" end="600"
            probability="0.03"
            from="top1" to="bottom0"/>

      <!-- Phase 2: 600-1200, heavy North<->South -->
      <flow id="w2e_midday" type="car"
            begin="600" end="1200"
            probability="0.03"
            from="left0" to="right1"/>
      <flow id="e2w_midday" type="car"
            begin="600" end="1200"
            probability="0.03"
            from="right1" to="left0"/>
      <flow id="s2n_midday" type="car"
            begin="600" end="1200"
            probability="0.08"
            from="bottom0" to="top1"/>
      <flow id="n2s_midday" type="car"
            begin="600" end="1200"
            probability="0.08"
            from="top1" to="bottom0"/>

      <!-- Phase 3: 1200-1800, balanced moderate -->
      <flow id="w2e_evening" type="car"
            begin="1200" end="1800"
            probability="0.04"
            from="left0" to="right1"/>
      <flow id="e2w_evening" type="car"
            begin="1200" end="1800"
            probability="0.04"
            from="right1" to="left0"/>
      <flow id="s2n_evening" type="car"
            begin="1200" end="1800"
            probability="0.04"
            from="bottom0" to="top1"/>
      <flow id="n2s_evening" type="car"
            begin="1200" end="1800"
            probability="0.04"
            from="top1" to="bottom0"/>
    </routes>
