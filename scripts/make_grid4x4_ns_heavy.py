...
NETDIR = os.path.join(ROOT, "envs", "grid4x4_ns_heavy")
...
def ensure_routes():
    ...
    <routes>
      ...
      <!-- East-West flows: lighter -->
      <flow id="w2e" type="car"
            begin="0" end="3600"
            probability="0.02"
            from="left0" to="right1"/>
      <flow id="e2w" type="car"
            begin="0" end="3600"
            probability="0.02"
            from="right1" to="left0"/>

      <!-- South-North flows: heavier -->
      <flow id="s2n" type="car"
            begin="0" end="3600"
            probability="0.08"
            from="bottom0" to="top1"/>
      <flow id="n2s" type="car"
            begin="0" end="3600"
            probability="0.08"
